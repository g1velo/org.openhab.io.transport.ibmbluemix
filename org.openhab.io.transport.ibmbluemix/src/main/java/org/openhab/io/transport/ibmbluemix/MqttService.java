...
import org.openhab.io.transport.ibmbluemix.internal.MqttBrokerConnection;
...
/**
 * IBM BLuemix Service for creating new connections to MQTT brokers from the openHAB
...
public class MqttService implements ManagedService {
    ...
    public void updated(Dictionary<String, ?> properties) throws ConfigurationException {
        ...
        logger.info("IBM BLuemix Service initialization completed.");

        for (MqttBrokerConnection con : brokerConnections.values()) {
            try {
                con.start();
            } catch (Exception e) {
                logger.error("An Error starting broker connection", e);
            }
        }
    }
    ...
    public void deactivate() {
        logger.debug("Stopping IBM BLuemix Service...");
        ...
        logger.debug("IBM BLuemix Service stopped.");
    }
